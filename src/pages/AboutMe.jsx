        ...
        <Container>
            <Row id='pageRow'>
                ...
                <Col id='aboutMeColumnText' md={6}>
                    ...
                    <h6 id='section-titles'>Introduction</h6>
                    ...
                    <h6 id='section-titles'>Experience</h6>
                    <p id='paragraph'>I have been self learning coding via online courses for over a year now, completed many solo and group projects, I have graduated from an intensive Front End Web Development boot camp, completed a 3 month internship as a Front End Web Development with a company called TrashCoin and then most recently I have worked with a company called Six for a week also doing Front End Web Development.</p>

                    <h6 id='section-titles'>Current Position</h6>
